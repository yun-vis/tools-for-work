...
- Research Question/Objectives
  - Please narrow down your research questions to three questions. Specify the challenges and explain if they are missing in the state-of-the-art.

- Research Strategy
  - It should be a concrete and detailed plan for what you will accomplish in the project. This includes
    - Environment setup (i.e., tools, programming language, software, library, etc., what you plan to use in the project)
    - The concrete methodology pipeline, including input/output, what approaches (algorithms, etc.) you plan to include step by step, the validation/evaluation (no. of participants you plan to recruit) of the proposed methods, and highlight how the proposed method could resolve your research questions and objectives.
...
- Planning
  - Use a table to summarize your schedule.
...
- Abstract should follow the order: Background -> Motivation -> Goal -> Method -> Result -> Evaluation
...
- Paper search engines: 
  ...
  - [Google scholar](http://scholar.google.com/schhp?tab=ws&hl=en) 
  - [Free preprints of published and not (yet) published papers](https://arxiv.org/)
- [How to write a scientific paper](https://www.cg.tuwien.ac.at/courses/Seminar/HowToWriteAScientificPaper.html)
- [Practical Tips and Tricks for Paper Writing](https://www.cg.tuwien.ac.at/research/publications/2010/groeller-2010-PTT/groeller-2010-PTT-.pdf)
- Use dictionaries to find synonyms: [Thesaurus](https://www.thesaurus.com/)
- Online corpora: [english-corpora](https://www.english-corpora.org/), [Phrasebank](https://www.phrasebank.manchester.ac.uk/)
- Grammar checkers: [Grammarly](https://app.grammarly.com/), [LanguageTool](https://languagetool.org/)
- Free online LaTeX editor: [Overleaf](https://www.overleaf.com)
